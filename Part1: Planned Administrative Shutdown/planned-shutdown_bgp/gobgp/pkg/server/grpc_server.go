...
func newGlobalFromAPIStruct(a *api.Global) *oc.Global {
	...
	var local0 oc.LocalPrefConfig
	if a.LocalPref_0 != nil {
		local0 = oc.LocalPrefConfig{
			LocalPref0Timer:     a.LocalPref_0.LocalPref_0Timer,
			LocalPref0Community: a.LocalPref_0.LocalPref_0Community,
		}
	}
