...
const (
	...
	COMMUNITY_PLANNED_SHUTDOWN           WellKnownCommunity = 0xffffff05
)
...
var WellKnownCommunityNameMap = map[WellKnownCommunity]string{
	...
	COMMUNITY_PLANNED_SHUTDOWN:           "planned-shutdown",
}
...
var WellKnownCommunityValueMap = map[string]WellKnownCommunity{
	...
	WellKnownCommunityNameMap[COMMUNITY_PLANNED_SHUTDOWN]:           COMMUNITY_PLANNED_SHUTDOWN,
}
