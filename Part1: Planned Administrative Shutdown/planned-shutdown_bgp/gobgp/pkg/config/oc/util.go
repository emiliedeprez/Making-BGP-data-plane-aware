...
func NewGlobalFromConfigStruct(c *Global) *api.Global {
	...
	localpref0 := &api.LocalPrefConfig{}
		if c.Config.LocalPref0 != (LocalPrefConfig{}){
			localpref0.LocalPref_0Community = c.Config.LocalPref0.LocalPref0Community
			localpref0.LocalPref_0Timer = c.Config.LocalPref0.LocalPref0Timer
		}
