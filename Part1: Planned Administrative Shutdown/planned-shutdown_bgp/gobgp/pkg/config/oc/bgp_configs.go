...
type LocalPrefConfig struct {
	LocalPref0Timer uint64 `mapstructure:"local-pref-0-timer" json:"local-pref-0-timer,omitempty"`
	LocalPref0Community string `mapstructure:"local-pref-0-community" json:"local-pref-0-community,omitempty"`
}

func (lhs *LocalPrefConfig) Equal(rhs *LocalPrefConfig) bool {
	if lhs == nil || rhs == nil {
		return false
	}
	if lhs.LocalPref0Timer != rhs.LocalPref0Timer {
		return false
	}
	if lhs.LocalPref0Community != rhs.LocalPref0Community {
		return false
	}
	return true
}
...
type GlobalConfig struct {
	...
	// original -> gobgp:local-address
	LocalAddressList []string `mapstructure:"local-address-list" json:"local-address-list,omitempty"`
	LocalPref0 LocalPrefConfig `mapstructure:"local-pref-0" json:"local-pref-0,omitempty"`
}
...
func (lhs *GlobalConfig) Equal(rhs *GlobalConfig) bool {
	...
	if (lhs.LocalPref0 != rhs.LocalPref0){
		return false
	}
	return true
}
