...
func showGlobalConfig() error {
	...
	if g.LocalPref_0.LocalPref_0Community != "" {
		fmt.Println("Local-pref 0 : activated")
		fmt.Println("timer : ", g.LocalPref_0.LocalPref_0Timer)
		fmt.Println("community : ", g.LocalPref_0.LocalPref_0Community)
	} else {
		fmt.Println("Local-pref 0 : desactivated")
	}
