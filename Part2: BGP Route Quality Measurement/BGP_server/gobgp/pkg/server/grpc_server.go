...
func (s *server) AddRQM(ctx context.Context, r *api.AddRQMRequest) (*emptypb.Empty, error) {
	return &emptypb.Empty{}, s.bgpServer.AddRQM(ctx, r)
}

func (s *server) DeleteRQM(ctx context.Context, r *api.DeleteRQMRequest) (*emptypb.Empty, error) {
	return &emptypb.Empty{}, s.bgpServer.DeleteRQM(ctx, r)
}

func (s *server) EnableRQM(ctx context.Context, r *api.EnableRQMRequest) (*emptypb.Empty, error) {
	return &emptypb.Empty{}, s.bgpServer.EnableRQM(ctx, r)
}

func (s *server) DisableRQM(ctx context.Context, r *api.DisableRQMRequest) (*emptypb.Empty, error) {
	return &emptypb.Empty{}, s.bgpServer.DisableRQM(ctx, r)
}

func (s *server) ResetRQM(ctx context.Context, r *api.ResetRQMRequest) (*emptypb.Empty, error) {
	return &emptypb.Empty{}, s.bgpServer.ResetRQM(ctx, r)
}

func (s *server) ListRQM(r *api.ListRQMRequest, stream api.GobgpApi_ListRQMServer) error {
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	fn := func(r *api.Rqm) {
		if err := stream.Send(&api.ListRQMResponse{Server: r}); err != nil {
			cancel()
		}
	}
	return s.bgpServer.ListRQM(ctx, r, fn)
}
